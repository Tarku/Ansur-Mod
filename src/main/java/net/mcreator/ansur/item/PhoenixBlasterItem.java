...
import net.mcreator.ansur.procedures.PhoenixBlasterRangedItemUsedProcedure;
import net.mcreator.ansur.entity.renderer.PhoenixBlasterRenderer;
...
public class PhoenixBlasterItem extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:phoenix_blaster")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(1200));
			setRegistryName("phoenix_blaster");
		}
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						}
						{
							...
							PhoenixBlasterRangedItemUsedProcedure.executeProcedure($_dependencies);
						}
					}
				}
			}
