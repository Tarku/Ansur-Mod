...
public class AidenPotionItem extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:aiden_potion")
	public static final Item block = null;
	public AidenPotionItem(AnsurModElements instance) {
		super(instance, 240);
	}
