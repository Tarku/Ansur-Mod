...
import net.mcreator.ansur.procedures.HelichrysumItalicumAdditionalGenerationConditionProcedure;
...
public class HelichrysumItalicumBlock extends AnsurModElements.ModElement {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!HelichrysumItalicumAdditionalGenerationConditionProcedure
			...
			event.getRegistry().register(feature.setRegistryName("helichrysum_italicum"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ansur:helichrysum_italicum"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("helichrysum_italicum");
		}
