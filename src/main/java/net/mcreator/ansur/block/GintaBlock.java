...
import net.mcreator.ansur.procedures.GintaUpdateTickProcedure;
...
public class GintaBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:ginta")
	public static final Block block = null;
	public GintaBlock(AnsurModElements instance) {
		super(instance, 233);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ginta"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ansur:ginta"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
			...
			return block == this || (block == NeutarastoneBlock.block.getDefaultState().getBlock());
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				GintaUpdateTickProcedure.executeProcedure($_dependencies);
			}
