...
public class ForwoodPlanksBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:forwood_planks")
	public static final Block block = null;
	public ForwoodPlanksBlock(AnsurModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("forwood_planks");
		}
