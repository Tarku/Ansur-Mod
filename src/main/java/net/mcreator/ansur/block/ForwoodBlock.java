...
public class ForwoodBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:forwood_log")
	public static final Block block = null;
	public ForwoodBlock(AnsurModElements instance) {
		super(instance, 19);
	}
