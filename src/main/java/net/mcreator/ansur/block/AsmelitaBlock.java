...
public class AsmelitaBlock extends AnsurModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("asmelita"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ansur:asmelita"), configuredFeature);
		}
	}
	@SubscribeEvent
