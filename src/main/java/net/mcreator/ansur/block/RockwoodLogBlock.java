...
public class RockwoodLogBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:rockwood_log")
	public static final Block block = null;
	public RockwoodLogBlock(AnsurModElements instance) {
		super(instance, 20);
	}
