...
public class ForgrassBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:forgrass")
	public static final Block block = null;
	public ForgrassBlock(AnsurModElements instance) {
		super(instance, 49);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("forgrass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ansur:forgrass"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).speedFactor(1.1f).setLightLevel(s -> 0));
			setRegistryName("forgrass");
		}
