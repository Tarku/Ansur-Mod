...
public class DanewoodPlanksStairsBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:danewood_planks_stairs")
	public static final Block block = null;
	public DanewoodPlanksStairsBlock(AnsurModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("danewood_planks_stairs");
		}
