...
public class DanewoodPlanksBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:danewood_planks")
	public static final Block block = null;
	public DanewoodPlanksBlock(AnsurModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("danewood_planks");
		}
