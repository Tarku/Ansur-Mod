...
public class DanewoodLogBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:danewood_log")
	public static final Block block = null;
	public DanewoodLogBlock(AnsurModElements instance) {
		super(instance, 21);
	}
