...
public class RockwoodPlanksStairsBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:rockwood_planks_stairs")
	public static final Block block = null;
	public RockwoodPlanksStairsBlock(AnsurModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("rockwood_planks_stairs");
		}
