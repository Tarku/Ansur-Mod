...
public class ForwoodPlanksSlabBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:forwood_planks_slab")
	public static final Block block = null;
	public ForwoodPlanksSlabBlock(AnsurModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("forwood_planks_slab");
		}
