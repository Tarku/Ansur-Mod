...
public class RockwoodPlanksBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:rockwood_planks")
	public static final Block block = null;
	public RockwoodPlanksBlock(AnsurModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rockwood_planks");
		}
