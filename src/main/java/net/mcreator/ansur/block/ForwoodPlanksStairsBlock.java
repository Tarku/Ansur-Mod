...
public class ForwoodPlanksStairsBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:forwood_planks_stairs")
	public static final Block block = null;
	public ForwoodPlanksStairsBlock(AnsurModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("forwood_planks_stairs");
		}
