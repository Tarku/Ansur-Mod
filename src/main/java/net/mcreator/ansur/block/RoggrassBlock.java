...
public class RoggrassBlock extends AnsurModElements.ModElement {
	@ObjectHolder("ansur:roggrass")
	public static final Block block = null;
	public RoggrassBlock(AnsurModElements instance) {
		super(instance, 51);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("roggrass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ansur:roggrass"), configuredFeature);
		}
	}
	@SubscribeEvent
