...
import net.mcreator.ansur.entity.renderer.DaneZombieRenderer;
import net.mcreator.ansur.AnsurModElements;

@AnsurModElements.ModElement.Tag
public class DaneZombieEntity extends AnsurModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -3394816, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("dane_zombie_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ansur:rockwoodrogue2"));
		}
