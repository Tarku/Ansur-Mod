...
import net.mcreator.ansur.entity.renderer.ForrockSpiderRenderer;
import net.mcreator.ansur.AnsurModElements;

@AnsurModElements.ModElement.Tag
public class ForrockSpiderEntity extends AnsurModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16724941, -16711834, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("forrock_spider_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("ansur:forbiome").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, ForwoodSpiderEntity.CustomEntity.class, false, false));
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, RockwoodRogueEntity.CustomEntity.class, false, false));
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, DaneZombieEntity.CustomEntity.class, false, false));
